...
# Selecting GUI theme and color
ctk.set_appearance_mode("dark")
ctk.set_default_color_theme("blue")

# Create main CTk window (not Tk)
root = ctk.CTk()
root.title("Dev's Library Management System")
...
def create_login_window():
    ...
    login_window.title("Login - Library Management System")
    ...
    def login():
        ...
        if user_entry.get() == username and user_pass.get() == password:
            ...
            mb.showwarning(title='Wrong password', message='Please check your password')
        elif user_entry.get() != username and user_pass.get() == password:
            mb.showwarning(title='Wrong username', message='Please check your username')
        else:
            mb.showerror(title="Login Failed", message="Invalid Username and password")
    
    label = ctk.CTkLabel(login_window, text="Library Management Login")
    label.pack(pady=20)
...
def setup_main_window():
    ...
    global bk_status, bk_name, bk_id, author_name, card_id
    global bk_id_entry, clear, submit
    global lf_bg, rtf_bg, rbf_bg, btn_hlb_bg
    global lbl_font, entry_font, btn_font
    ...
    # Top Label
    Label(root, text='DEV NAMBIAR LIBRARY MANAGEMENT SYSTEM', font=("Noto Sans CJK TC", 15, 'bold'),
